...
a) Click on this link to open it with Gitpod (recommended): https://gitpod.io#https://github.com/JimenaEB/4Geeks-Academy_exercise_conditional-profile-card.git

b) If you don't have Gitpod, you can clone this repository on your local computer:

```sh
$ git clone https://github.com/JimenaEB/4Geeks-Academy_exercise_conditional-profile-card
````
